                ...
                <div className="row">
                    <div className="col-md-6 col-lg-6 col-xl-4 text-center mb-5 mb-lg-5">
                        <div className="h-100 p-4 p-lg-5 site-block-feature-7">
                            ...
                            <h3 className="text-white h4">Camera</h3>
                    ...
                    <div className="col-md-6 col-lg-6 col-xl-4 text-center mb-5 mb-lg-5">
                        <div className="h-100 p-4 p-lg-5 site-block-feature-7">
                            ...
                            <h3 className="text-white h4">Wedding Photography</h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum exercitationem quae id
                                dolorum debitis.</p>
                    ...
                    <div className="col-md-6 col-lg-6 col-xl-4 text-center mb-5 mb-lg-5">
                        <div className="h-100 p-4 p-lg-5 site-block-feature-7">
                            ...
                            <h3 className="text-white h4">Portrait</h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum exercitationem quae id
                                dolorum debitis.</p>
                    ...
                    <div className="col-md-6 col-lg-6 col-xl-4 text-center mb-5 mb-lg-5">
                        <div className="h-100 p-4 p-lg-5 site-block-feature-7">
                            ...
                            <h3 className="text-white h4">Travel</h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum exercitationem quae id
                                dolorum debitis.</p>
                    ...
                    <div className="col-md-6 col-lg-6 col-xl-4 text-center mb-5 mb-lg-5">
                        <div className="h-100 p-4 p-lg-5 site-block-feature-7">
                            ...
                            <h3 className="text-white h4">Video Editing</h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum exercitationem quae id
                                dolorum debitis.</p>
